...
## Purpose
Specify the project's semantic versioning: meson.build as the single source of truth, a manually
bumped pre-release postfix, and a tag-matches-version CI gate.
