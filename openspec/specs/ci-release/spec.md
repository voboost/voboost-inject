...
## Purpose
Specify publishing the signed device binary, the OTA release manifest, and its detached signature as
release artifacts, with nothing published on earlier failure.
