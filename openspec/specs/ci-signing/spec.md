...
## Purpose
Specify release-time signing of the OTA release manifest with the ed25519 key from CI secrets:
private-key hygiene, committed-public-key verification, and no signing on non-release builds.
